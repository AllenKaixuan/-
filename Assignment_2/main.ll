...
define dso_local void @output(i32 noundef %0, i32 noundef %1) #0 {
  ...
  %7 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i64 0, i64 0), i32 noundef %5, i32 noundef %6)
  ret void
}
...
define dso_local i32 @main() #0 {
  ...
  %5 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([31 x i8], [31 x i8]* @.str.1, i64 0, i64 0))
...
19:                                               ; preds = %8
  ...
  call void @output(i32 noundef %21, i32 noundef %22)
  ret i32 0
}
